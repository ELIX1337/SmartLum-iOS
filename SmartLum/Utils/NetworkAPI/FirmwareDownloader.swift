...
/// ВНИМАНИЕ: Этот код использовался для тестирования DFU. Все что здесь описано не имеет применения в продакшене!
/// Данный класс использовался для скачивания прошики устройства с сервера.
